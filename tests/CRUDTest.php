 ...
 * @link     php vendor/bin/phpunit tests/CRUDTest.php
 */

namespace Test;

use PHPUnit\Framework\TestCase;
use Test\MykrORMTestModel;
...
class CRUDTest extends TestCase
{
    ...
    /**
     * Delete DB sqlite file when finished
     */
    ...
    public function updateProvider(): array
    {
        return [
            ...
            'success-false' => [
                'model' => '\Test\MykrORMTestFalseModel',
                'criteria' => ['name' => 1],
                'update' => [
                    'setName' => 1,
                    'setIsValid' => false,
            ...
            'fail-table' => [
                ...
                'expect' => ['exception' => 'Test\MykrORMTestModel Not Found!'],
                'exec' => '$this->testModel->destroyDB();'
                    . ' $this->testModel = new \Test\MykrORMTestModel();',
            ],
            'fail-empty' => [
